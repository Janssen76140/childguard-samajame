<section id="section1Homepage" style="background-image: url('../public/asset/img/bansamajamegrosse.svg')">
    <div class="opacity">
...
<section id="section1HomepageResponsive">
    <h3 class="rechercheTitre">Recherche de crèche:</h3>
    <div class="adresse_searchResponsive">
        <label class="labelAdresse" for="distance">Adresse:</label>

        <input id="adresse_searchResponsive" name="distance" value="" placeholder="Indiquez votre adresse"
               type="text">
    </div>
    <div class="distanceResponsive">
        <label class="labelDistance" for="distance">Sélectionnez un rayon:</label>
        <select name="distance" id="distanceResponsive">
            <option value="">1Km</option>
            <option value="">5Km</option>
            <option value="">10Km</option>
            <option value="">30Km</option>
    ...
    <div class="goResponsive">
        <input id="goResponsive" type="submit" name="submitted" value="GO !">
    </div>
</section>

<section id="section2Homepage">
    <h3 class="service">Nos services:</span></h3>
    ...
    <div class="nosServicesResponsive">
        <div class="serviceReponsive1">

...
if ( ! function_exists( 'childguard_setup' ) ) :
	...
	function childguard_setup() {
		 ...
		 * If you're building a theme based on childguard, use a find and replace
		 * to change 'childguard' to the name of your theme in all the template files.
		 */
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'childguard' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'childguard_custom_background_args', array(
